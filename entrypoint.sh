...
then 
  git --git-dir="$GITHUB_WORKSPACE/.git" log --left-right --cherry-pick --pretty=format:"%H" remotes/origin/$GITHUB_HEAD_REF...remotes/origin/$GITHUB_BASE_REF> commit_list.txt
